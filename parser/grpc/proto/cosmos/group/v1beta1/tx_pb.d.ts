...
export class MsgCreateGroupWithPolicy extends jspb.Message {
  ...
  getGroupMetadata(): Uint8Array | string;
  getGroupMetadata_asU8(): Uint8Array;
  getGroupMetadata_asB64(): string;
  setGroupMetadata(value: Uint8Array | string): void;

  getGroupPolicyMetadata(): Uint8Array | string;
  getGroupPolicyMetadata_asU8(): Uint8Array;
  getGroupPolicyMetadata_asB64(): string;
  setGroupPolicyMetadata(value: Uint8Array | string): void;
...
export namespace MsgCreateGroupWithPolicy {
  export type AsObject = {
    admin: string,
    membersList: Array<cosmos_group_v1beta1_types_pb.Member.AsObject>,
    groupMetadata: Uint8Array | string,
    groupPolicyMetadata: Uint8Array | string,
...
export class MsgVote extends jspb.Message {
  ...
  getOption(): cosmos_group_v1beta1_types_pb.VoteOptionMap[keyof cosmos_group_v1beta1_types_pb.VoteOptionMap];
  setOption(value: cosmos_group_v1beta1_types_pb.VoteOptionMap[keyof cosmos_group_v1beta1_types_pb.VoteOptionMap]): void;
...
export namespace MsgVote {
  export type AsObject = {
    proposalId: number,
    voter: string,
    option: cosmos_group_v1beta1_types_pb.VoteOptionMap[keyof cosmos_group_v1beta1_types_pb.VoteOptionMap],
    metadata: Uint8Array | string,
    exec: ExecMap[keyof ExecMap],
  }
}
