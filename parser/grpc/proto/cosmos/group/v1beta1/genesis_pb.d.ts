...
// file: cosmos/group/v1beta1/genesis.proto
...
export class GenesisState extends jspb.Message {
  ...
  getGroupMembersList(): Array<cosmos_group_v1beta1_types_pb.GroupMember>;
  setGroupMembersList(value: Array<cosmos_group_v1beta1_types_pb.GroupMember>): void;
  addGroupMembers(value?: cosmos_group_v1beta1_types_pb.GroupMember, index?: number): cosmos_group_v1beta1_types_pb.GroupMember;

  getGroupPolicySeq(): number;
  setGroupPolicySeq(value: number): void;

  clearGroupPoliciesList(): void;
  getGroupPoliciesList(): Array<cosmos_group_v1beta1_types_pb.GroupPolicyInfo>;
  setGroupPoliciesList(value: Array<cosmos_group_v1beta1_types_pb.GroupPolicyInfo>): void;
  addGroupPolicies(value?: cosmos_group_v1beta1_types_pb.GroupPolicyInfo, index?: number): cosmos_group_v1beta1_types_pb.GroupPolicyInfo;
...
export namespace GenesisState {
  export type AsObject = {
    ...
    groupMembersList: Array<cosmos_group_v1beta1_types_pb.GroupMember.AsObject>,
    groupPolicySeq: number,
    groupPoliciesList: Array<cosmos_group_v1beta1_types_pb.GroupPolicyInfo.AsObject>,
    proposalSeq: number,
