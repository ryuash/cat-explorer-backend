...
export class QueryGroupPolicyInfoResponse extends jspb.Message {
  hasInfo(): boolean;
  clearInfo(): void;
  getInfo(): cosmos_group_v1beta1_types_pb.GroupPolicyInfo | undefined;
  setInfo(value?: cosmos_group_v1beta1_types_pb.GroupPolicyInfo): void;
...
export namespace QueryGroupPolicyInfoResponse {
  export type AsObject = {
    info?: cosmos_group_v1beta1_types_pb.GroupPolicyInfo.AsObject,
  }
}
