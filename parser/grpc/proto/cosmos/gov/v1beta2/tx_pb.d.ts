...
export class MsgVote extends jspb.Message {
  ...
  getOption(): cosmos_gov_v1beta2_gov_pb.VoteOptionMap[keyof cosmos_gov_v1beta2_gov_pb.VoteOptionMap];
  setOption(value: cosmos_gov_v1beta2_gov_pb.VoteOptionMap[keyof cosmos_gov_v1beta2_gov_pb.VoteOptionMap]): void;
...
export namespace MsgVote {
  export type AsObject = {
    proposalId: number,
    voter: string,
    option: cosmos_gov_v1beta2_gov_pb.VoteOptionMap[keyof cosmos_gov_v1beta2_gov_pb.VoteOptionMap],
  }
}
...
export class MsgVoteWeighted extends jspb.Message {
  ...
  getOptionsList(): Array<cosmos_gov_v1beta2_gov_pb.WeightedVoteOption>;
  setOptionsList(value: Array<cosmos_gov_v1beta2_gov_pb.WeightedVoteOption>): void;
  addOptions(value?: cosmos_gov_v1beta2_gov_pb.WeightedVoteOption, index?: number): cosmos_gov_v1beta2_gov_pb.WeightedVoteOption;
...
export namespace MsgVoteWeighted {
  export type AsObject = {
    proposalId: number,
    voter: string,
    optionsList: Array<cosmos_gov_v1beta2_gov_pb.WeightedVoteOption.AsObject>,
  }
}
