...
import * as cosmos_gov_v1beta2_gov_pb from "../../../cosmos/gov/v1beta2/gov_pb";
...
export class QueryProposalResponse extends jspb.Message {
  hasProposal(): boolean;
  clearProposal(): void;
  getProposal(): cosmos_gov_v1beta2_gov_pb.Proposal | undefined;
  setProposal(value?: cosmos_gov_v1beta2_gov_pb.Proposal): void;
...
export namespace QueryProposalResponse {
  export type AsObject = {
    proposal?: cosmos_gov_v1beta2_gov_pb.Proposal.AsObject,
  }
}

export class QueryProposalsRequest extends jspb.Message {
  getProposalStatus(): cosmos_gov_v1beta2_gov_pb.ProposalStatusMap[keyof cosmos_gov_v1beta2_gov_pb.ProposalStatusMap];
  setProposalStatus(value: cosmos_gov_v1beta2_gov_pb.ProposalStatusMap[keyof cosmos_gov_v1beta2_gov_pb.ProposalStatusMap]): void;
...
export namespace QueryProposalsRequest {
  export type AsObject = {
    proposalStatus: cosmos_gov_v1beta2_gov_pb.ProposalStatusMap[keyof cosmos_gov_v1beta2_gov_pb.ProposalStatusMap],
    voter: string,
    depositor: string,
...
export class QueryProposalsResponse extends jspb.Message {
  ...
  getProposalsList(): Array<cosmos_gov_v1beta2_gov_pb.Proposal>;
  setProposalsList(value: Array<cosmos_gov_v1beta2_gov_pb.Proposal>): void;
  addProposals(value?: cosmos_gov_v1beta2_gov_pb.Proposal, index?: number): cosmos_gov_v1beta2_gov_pb.Proposal;
...
export namespace QueryProposalsResponse {
  export type AsObject = {
    proposalsList: Array<cosmos_gov_v1beta2_gov_pb.Proposal.AsObject>,
...
export class QueryVoteResponse extends jspb.Message {
  hasVote(): boolean;
  clearVote(): void;
  getVote(): cosmos_gov_v1beta2_gov_pb.Vote | undefined;
  setVote(value?: cosmos_gov_v1beta2_gov_pb.Vote): void;
...
export namespace QueryVoteResponse {
  export type AsObject = {
    vote?: cosmos_gov_v1beta2_gov_pb.Vote.AsObject,
  }
}
...
export class QueryVotesResponse extends jspb.Message {
  clearVotesList(): void;
  getVotesList(): Array<cosmos_gov_v1beta2_gov_pb.Vote>;
  setVotesList(value: Array<cosmos_gov_v1beta2_gov_pb.Vote>): void;
  addVotes(value?: cosmos_gov_v1beta2_gov_pb.Vote, index?: number): cosmos_gov_v1beta2_gov_pb.Vote;
...
export namespace QueryVotesResponse {
  export type AsObject = {
    votesList: Array<cosmos_gov_v1beta2_gov_pb.Vote.AsObject>,
    pagination?: cosmos_base_query_v1beta1_pagination_pb.PageResponse.AsObject,
  }
}
...
export class QueryParamsResponse extends jspb.Message {
  ...
  getVotingParams(): cosmos_gov_v1beta2_gov_pb.VotingParams | undefined;
  setVotingParams(value?: cosmos_gov_v1beta2_gov_pb.VotingParams): void;

  hasDepositParams(): boolean;
  clearDepositParams(): void;
  getDepositParams(): cosmos_gov_v1beta2_gov_pb.DepositParams | undefined;
  setDepositParams(value?: cosmos_gov_v1beta2_gov_pb.DepositParams): void;

  hasTallyParams(): boolean;
  clearTallyParams(): void;
  getTallyParams(): cosmos_gov_v1beta2_gov_pb.TallyParams | undefined;
  setTallyParams(value?: cosmos_gov_v1beta2_gov_pb.TallyParams): void;
...
export namespace QueryParamsResponse {
  export type AsObject = {
    votingParams?: cosmos_gov_v1beta2_gov_pb.VotingParams.AsObject,
    depositParams?: cosmos_gov_v1beta2_gov_pb.DepositParams.AsObject,
    tallyParams?: cosmos_gov_v1beta2_gov_pb.TallyParams.AsObject,
  }
}
...
export class QueryDepositResponse extends jspb.Message {
  hasDeposit(): boolean;
  clearDeposit(): void;
  getDeposit(): cosmos_gov_v1beta2_gov_pb.Deposit | undefined;
  setDeposit(value?: cosmos_gov_v1beta2_gov_pb.Deposit): void;
...
export namespace QueryDepositResponse {
  export type AsObject = {
    deposit?: cosmos_gov_v1beta2_gov_pb.Deposit.AsObject,
  }
}
...
export class QueryDepositsResponse extends jspb.Message {
  ...
  getDepositsList(): Array<cosmos_gov_v1beta2_gov_pb.Deposit>;
  setDepositsList(value: Array<cosmos_gov_v1beta2_gov_pb.Deposit>): void;
  addDeposits(value?: cosmos_gov_v1beta2_gov_pb.Deposit, index?: number): cosmos_gov_v1beta2_gov_pb.Deposit;
...
export namespace QueryDepositsResponse {
  export type AsObject = {
    depositsList: Array<cosmos_gov_v1beta2_gov_pb.Deposit.AsObject>,
    pagination?: cosmos_base_query_v1beta1_pagination_pb.PageResponse.AsObject,
  }
}
...
export class QueryTallyResultResponse extends jspb.Message {
  hasTally(): boolean;
  clearTally(): void;
  getTally(): cosmos_gov_v1beta2_gov_pb.TallyResult | undefined;
  setTally(value?: cosmos_gov_v1beta2_gov_pb.TallyResult): void;
...
export namespace QueryTallyResultResponse {
  export type AsObject = {
    tally?: cosmos_gov_v1beta2_gov_pb.TallyResult.AsObject,
  }
}
