...
export class MsgClient extends grpc.Client {
  ...
  unjail(argument: cosmos_slashing_v1beta1_tx_pb.MsgUnjail, callback: grpc.requestCallback<cosmos_slashing_v1beta1_tx_pb.MsgUnjailResponse>): grpc.ClientUnaryCall;
  unjail(argument: cosmos_slashing_v1beta1_tx_pb.MsgUnjail, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<cosmos_slashing_v1beta1_tx_pb.MsgUnjailResponse>): grpc.ClientUnaryCall;
  unjail(argument: cosmos_slashing_v1beta1_tx_pb.MsgUnjail, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<cosmos_slashing_v1beta1_tx_pb.MsgUnjailResponse>): grpc.ClientUnaryCall;
}
